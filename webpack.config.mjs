  ...
  return {
    ...
    plugins: [
      ...
      new Repack.plugins.ModuleFederationPlugin({
         ...
         */
        shared: {
          react: { singleton: true, eager: STANDALONE, requiredVersion: '18.2.0' },
          'react-native': { singleton: true, eager: STANDALONE, requiredVersion: '0.74.3' }
        }
      }),
    ],
  };
